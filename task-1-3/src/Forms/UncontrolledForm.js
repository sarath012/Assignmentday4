  ...
  const handlesubmit = (e) => {
    ...
    if (firstName.current.value === "") {
      ...
      state = false;
        ...
        state = false;
    } else if ( firstName.current.value.length < 3 || firstName.current.value > 15 ) {
    ...
    if (lastName.current.value === "") {
        ...
        state = false;
    } else if ( lastName.current.value.length < 3 || lastName.current.value > 15 ) {
        ...
        <form onSubmit={handlesubmit}>
          ...
          <div>
            <select ref={secQuestion}>
              <option value="none" defaultValue>Select a question</option>
